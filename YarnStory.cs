...
->판매한다.
->말을건다.
  "그래 내가 이 마을에 유일한 대장장이다! 특별한 재료를 가져오면 원하는 무기를 만들어 줄 수도 있지, 물론 그런 재료를 니가 가져올 수 있을지는 모르겠지만 말이야 하하하!!!"

  /// 보스무기를 만들 때
  "...분에 넘치걸 가져왔군 애송이, 이런 말 하기 싫지만 이건 나로선 못 만든다. 혹여 만든다 해도 엉망일거야...쯧 기다려봐" 그는 잠시 뒤에서 무언가를 끄적이더니 나에게 무언가를 내밀었다
  "여기로 가봐 이 근방에서 이런 물건을 만들 수 있는 건 이 양반 뿐일테니까." 내게 말하는 그의 목소리에선 연민과 후회로 얼룩져있는 듯 했다
->가게를 나온다
===
...
"못 보던 손님이네 편한대로 고르세요 없으면 주문제작도 가능하답니다." 
...
->말을건다.
  ...
  ->수락한다
    "고마워 안그래도 골란하던 참이거든 그렇게 어려운건 아니야 가게 뒤편에서 이어지는 언덕을 따라 올라가면 푸른손가락 꽃이 가득한 군락지가 나와 거기서 꽃을 따와주면 돼 어렵지 않지?"
    나는 꽃을 담을 바구니를 받고선 안내를 받아 언덕으로 올라가는 길 앞에 섰다
    "...조심해 무슨일 있을지도 모르잖아? 본인 몸정도는 지킬 수 있지?"
    어딘가 수상한 말과는 다르게 나를 훑어보는 그녀의 눈 빛은 무언가 걱정스러움과 약간의 기대를 품고있는 듯 했다 나는 고개를 끄덕이고는 언덕을 올라갔다
  ->거절한다
