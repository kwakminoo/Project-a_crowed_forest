...
피드백
-
읽은 부분은 그리 길지 않고 세계관이나 캐릭터에 대한 깊은 영역을 제시하지는 않기에 캐릭터 시트와 세계관 정리, 스페인이나 가문의 이야기 등을 피드백하지는 않겠음.
다분히 흥미롭고 이걸 어떻게 풀어가는가가 중요하기 때문임.
황색 성역 파트를 쓸 때 만연체를 의도하고 말꼬리를 늘였는지는 모르겠으나, 만연체를 쓴다고 해서 추상어나 한자어(안도와 희망이 어린, 아비규환), 관용적인 어구를 많이 쓸 필요는 없다.
해당 표현들이 많아질수록 글은 이야기라는 느낌보다 비평문이라는 느낌을 받기가 쉽다. 황색 성역 파트가 그렇다. 분명히 게임 속 등장하는 인물의 독백이 위주인 이야기일텐데
읽다보면 이야기를 보고 있는 독자가 정리한 감상문이라는 생각이 드는 경우가 많다.
특히 지하실에서 철창 속에 갇힌 인물들과 대면한 이후의 부분이 그렇다. 주인공이 냉정하고 고독하기에 갇혀있는 사람들에게 어떠한 정이나 연민을 느끼지 못하고 관찰자로서 기능하는 것은 이해된다.
그렇다면 굳이 구원이니 욕망이니 하는 추상어를 내세워 사람들을 판단하고 관찰하기 보다 그들의 행동을 그대로 비추는 것이 나을 것 같다. 
